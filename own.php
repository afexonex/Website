    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <select id="gate" class="form-control mb-2">
          <option value="./Gate/sho.php">SELF AUTOSHOPIFY </option>
        </select>

        <input type="text" id="customSite" class="form-control mb-2" placeholder="Enter your site URL here (e.g. https://yoursite.com)">
...
<script>
  ...
  window.onload = () => {
    ...
    if (savedSite) {
      customSiteInput.value = savedSite;
    }
  };
  ...
  startBtn.addEventListener('click', async () => {
    ...
    if (!gate || !site) {
      alert('Please select a gateway and enter a site URL.');
      return;
    }
    ...
    for (let i = 0; i < cards.length; i++) {
      ...
      try {
        const res = await fetch(gate, {
          ...
          body: 'cc=' + encodeURIComponent(cc) + '&custom_site=' + encodeURIComponent(site)
        });
