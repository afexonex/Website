...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    <h2 class="mb-1 mt-4">This Gate is Under Maintenance</h2>
    <p class="mb-4 mx-2">We are currently performing scheduled maintenance to improve our services. The gate will be back online shortly. Thank you for your patience!</p>
    <ul class="mb-4 mx-2">
      <li>Estimated Downtime: <strong>2 hours</strong></li>
      <li>Current Status: <strong>Upgrading Systems</strong></li>

    </ul>
    <a href="index.php" class="btn btn-primary mb-4">Back to Home</a>

    <div class="mt-4">
      <p class="text-muted">We apologize for any inconvenience caused. Please feel free to reach out to our support team for assistance.</p>
    </div>
  </div>
</div>
