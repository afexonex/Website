...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Query to check if the user exists with the given email or username
    $sql = "SELECT * FROM users WHERE email = '$email_or_username' OR username = '$email_or_username' LIMIT 1";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $error_message = "No account found with this email or username.";
    }
}
?>
<!DOCTYPE html>
...
<!-- / Content -->
  ...
  <div class="buy-now">
    <a href="http://t.me/SemuPremiumBot" target="_blank" class="btn btn-danger btn-buy-now">Buy Now</a>
  </div>
        ...
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center mb-4 mt-2">
            <a href="index.html" class="app-brand-link gap-2">
              ...
              <span class="app-brand-text demo text-body fw-bold ms-1">Blue Eye</span>
            </a>
          </div>
          <!-- /Logo -->
          <h4 class="mb-1 pt-2">Welcome to Blue Eye! 👋</h4>
          ...
          <!-- Login Form -->
          <form id="formAuthentication" class="mb-3" method="POST" onsubmit="validateLoginForm(event)">
            <div class="mb-3">
...
<script src="./assets/vendor/libs/@form-validation/umd/plugin-auto-focus/index.min.js"></script>
  ...
  function validateLoginForm(event) {
    ...
    if (errors.length > 0) {
      ...
      // Optionally redirect or process login
      setTimeout(() => {
